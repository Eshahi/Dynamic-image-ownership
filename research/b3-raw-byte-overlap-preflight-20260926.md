...
Five focused model-free tests cover stable groups/input permutation, duplicate IDs and conflicting digest metadata, complete/partial ZIP frames, unknown headers/digests and cross-part versus cross-source labeling. Independent exact-artifact review is pending at this authored checkpoint. A5 canonical RGB8/EXIF/ICC handling and B4/B5 dependence decisions remain separate; neither raw grouping nor PNG integrity acceptance substitutes for them. B3 and all dependent gates remain open.

...
Five focused model-free tests cover normalized groups/no text export, cutoff/sentinel/empty/precedence, malformed excluded rows, incomplete production frame and complete synthetic ledger/count-disagreement failure. Independent exact-artifact review is pending at this authored checkpoint. B3 remains open for remaining actual archives, item-level content/rights and dependence controls, final manifest and development IDs; B5/B4/C2 remain dependent, and the official plan gate stays paused. No scientific compute is authorized or claimed.

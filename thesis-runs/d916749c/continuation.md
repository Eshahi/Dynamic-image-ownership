...
2. Complete A3 (issue #3): I/O, notation, and threat model, then A2b. A3 depends on completed A2a, not on completion of B1. Preserve TBD architecture parameters until evidence/feasibility resolves them; no placeholder is an executable method.

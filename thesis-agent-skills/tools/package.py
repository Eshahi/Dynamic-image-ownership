...
def main():
    ...
    metadata={"schema_version":"1.0","name":"thesis-agent-skills","version":"1.2.0","skills":sorted(p.name for p in (ROOT/"skills").iterdir() if p.is_dir()),"profiles":{"controller":["thesis-workflow-control","thesis-research-handoff"],"worker":"all-eight","reviewer":["thesis-literature-synthesis","thesis-results-analysis","thesis-evidence-audit","thesis-writing"]},"spec_kit":{"commit":"d4229c071c7ea3885b43e8a7739847300f618f13","version":"1.0.9.dev0","schema_version":"1.0"},"tests":tests,"capabilities":{"local_execution":True,"mock_runpod":True,"codex_remote_human_channel":True,"live_runpod_creation":False,"live_runpod_artifact_transfer":False},"files":[{"path":p.relative_to(ROOT).as_posix(),"sha256":sha(p)} for p in files],"checksum_policy":"Manifest lists payload excluding itself and CHECKSUMS.sha256; checksum file includes manifest but excludes itself; archive has an external checksum"}

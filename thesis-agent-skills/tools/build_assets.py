...
"helper":"control", "scripts":{"spec_control.py":"control","import_thesis_guide.py":"guide","telegram_bridge.py":"telegram_bridge"},
...
"outputs":"Stable JSON status, bounded notification, approval review package, normalized guide JSON and optional Telegram delivery state."},
